    ...
    <>
      ...
      <AppBar position="fixed" className={classes.appBar}>
        <Paper className={classes.toggleButton}>
          <Button onClick={goToNextSeason} disabled={noNextSeason}>
            <BackIcon />
          </Button>
          <Button onClick={() => setExpand(!expanded)}>
            {seasonToText(currentSeason)}
          </Button>
          <Button onClick={goToPreviousSeason} disabled={noPreviousSeason}>
            <NextIcon />
          </Button>
        </Paper>
          ...
          <Toolbar className={classes.toolBar}>
            <FormControl className={classes.formControl}>
              <Select
                ...
                onChange={(e) =>
                  dispatch(
                    Action.applyFilter({ ...filter, category: e.target.value })
                  )
                }
              >
                <MenuItem value={FilterOption.ALL_ANIME}>All Anime</MenuItem>
                {isAdmin && (
                  <MenuItem value={FilterOption.ONLY_UNSEEN}>
                    Unfinished
                  </MenuItem>
                )}
                <MenuItem value={FilterOption.ONLY_UNFINISH}>
                  Incomplete
                </MenuItem>
            ...
            <FormControl className={classes.formControl}>
              <Select
                ...
                onChange={(e) =>
                  dispatch(
                    Action.applyFilter({ ...filter, season: e.target.value })
                  )
                }
              >
            ...
            <FormControl className={classes.formControl}>
              <Select
                ...
                onChange={(e) =>
                  dispatch(
                    Action.applyFilter({ ...filter, orderBy: e.target.value })
                  )
                }
              >
                <MenuItem value={FilterOption.SORT_BY_SEASON}>
                  Sort by Season
                </MenuItem>
                <MenuItem value={FilterOption.SORT_BY_SCORE}>
                  Sort by Score
                </MenuItem>
              </Select>
            </FormControl>
            <FormControl className={classes.formControl}>
              <TextField
                ...
                onBlur={(e) =>
                  dispatch(
                    Action.applyFilter({ ...filter, keyword: e.target.value })
                  )
                }
              />
            </FormControl>
